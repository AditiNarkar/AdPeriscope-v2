...
Feature folders are reserved for deeper domain slices as the product grows:

- `seo`: keyword research, intent clustering, semantic grouping, and content gap screens.
